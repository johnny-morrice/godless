...
func (p *QueryParser) Init() {
	...
	_rules = [...]func() bool{
		...
		nil,
		/* 12 WhereClause <- <(Action10 (AndClause / OrClause / PredicateClause) Action11)> */
		func() bool {
			position62, tokenIndex62 := position, tokenIndex
			{
				...
				l71:
					...
					l81:
						...
						position++
						add(rulePredicateClause, position76)
					}
				}
			l65:
				{
		...
		nil,
		/* 16 Predicate <- <(<KeySymbols> Action15)> */
		nil,
