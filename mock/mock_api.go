...
// Source: github.com/johnny-morrice/godless/api (interfaces: Core,RemoteStore,RemoteNamespace,NamespaceSearcher,DataPeer,PubSubSubscription,PubSubRecord,Service)
...
func (_m *MockService) Call(_param0 api.Request) (<-chan api.Response, error) {
	ret := _m.ctrl.Call(_m, "Call", _param0)
	ret0, _ := ret[0].(<-chan api.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockServiceRecorder) Call(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "Call", arg0)
}

func (_m *MockService) CloseAPI() {
	_m.ctrl.Call(_m, "CloseAPI")
}

func (_mr *_MockServiceRecorder) CloseAPI() *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CloseAPI")
}
